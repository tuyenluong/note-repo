...
-   If we look at this, this is under a fig caption div, so we could return this entire div. However, this is going to be a `WebElement` and remember we don't want to return `WebElement` objects to our test methods.
